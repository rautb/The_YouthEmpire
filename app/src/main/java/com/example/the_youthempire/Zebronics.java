...
public class Zebronics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zebronics);
        ...
        zn=(TextView)findViewById(R.id.zn);
        ...
        public void run() {
            StringRequest stringRequest=new StringRequest(Request.Method.POST, uploadPayment, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("ph_no",p);
                    params.put("product",zn.getText().toString());//name should be same as database
                    return params;
                }
            };
