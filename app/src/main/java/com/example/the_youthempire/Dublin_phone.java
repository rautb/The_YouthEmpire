...
public class Dublin_phone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dublin_phone);
        ...
        public void run() {
            StringRequest stringRequest=new StringRequest(Request.Method.POST, uploadPayment, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("ph_no",p);
                    params.put("product",df.getText().toString());//name should be same as database
                    return params;
                }
            };
